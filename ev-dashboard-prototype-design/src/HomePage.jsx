...
Never say you can't do something — give a helpful answer always.`,
  ...
  const speakReply = (text) => {
    ...
    const pick =
      voices.find((v) => /samantha|karen|google uk|daniel/i.test(v.name)) ??
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            animation:
              mode === "listening" ? "evPulse 1s ease-in-out infinite" : "none",
