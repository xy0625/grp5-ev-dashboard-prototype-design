...
function TopBar({ theme }) {
  ...
  return (
    <div style={{ position:"absolute", left:0, top:0, width:1280, height:62, background: t.topBarBg }}>
      ...
      <div style={{ position:"absolute", left:500, top:8, width:300, height:48, display:"flex", alignItems:"center", gap:14, padding:"0 18px", background: t.aiBg, backdropFilter:"blur(14px)", border: t.aiBorder, borderRadius:999, boxShadow:"0px 4px 20px rgba(99,102,241,0.12)" }}>
        ...
        <div style={{ fontFamily:"Inter", fontWeight:500, fontSize:16, color: t.aiText, letterSpacing:"0.2px" }}>Ask EV Assistant...</div>
        <div style={{ marginLeft:"auto", display:"flex", gap:4 }}>
          {[0,1,2].map((i) => (
            <div key={i} style={{ width:6, height:6, borderRadius:"50%", background:"#6366F1", opacity:0.5+i*0.2 }}/>
          ))}
        </div>
      </div>
