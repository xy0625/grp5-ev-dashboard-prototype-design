...
const tk = (theme) => {
  ...
  return {
    ...
    btnBg:       dark ? "#E8EAF0" : "#0F1117",   // ← login button bg
    btnColor:    dark ? "#0F1117" : "#F8F9FB",   // ← login button text
    accentBlue:  "#1a73e8",
  };
};
...
export default function LoginPage({ theme = "dark", onLoginSuccess }) {
  ...
  const inputSt = {
    ...
    border: t.inputBorder, boxSizing: 'border-box',
        ...
        <div style={{ animation: 'fadeIn 0.3s ease-in-out' }}>
          ...
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: '15px', textAlign: 'left' }}>
              <input type="text" placeholder="Full Name" style={inputSt} />
            </div>
            <div style={{ marginBottom: '15px', textAlign: 'left' }}>
              <input type="email" placeholder="Email Address" style={inputSt} />
            </div>
            <div style={{ marginBottom: '20px', textAlign: 'left' }}>
              <input type="password" placeholder="Create Password" style={inputSt} />
            </div>
    ...
    if (loginStep === 'google') {
      return (
        <div style={{ animation: 'fadeIn 0.3s ease-in-out' }}>
          ...
          <div style={{
            margin: '25px 0', padding: '12px',
            backgroundColor: t.inputBg, borderRadius: '12px',
      ...
      return (
        <div style={{ animation: 'fadeIn 0.3s ease-in-out' }}>
          ...
          <div style={{ marginBottom: '20px' }}>
            <input type="text" defaultValue="apple.user@icloud.com" style={{ ...inputSt, textAlign: 'center' }} />
          </div>
      ...
      <>
        ...
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: '20px', textAlign: 'left' }}>
            ...
            <input type="email" placeholder="Enter your email..." style={inputSt} />
          </div>
          ...
          {/* ✅ Fixed: uses theme tokens instead of hardcoded colours */}
          <button type="submit" style={{
            width: '100%', padding: '16px', fontSize: '18px', fontWeight: 'bold',
            backgroundColor: t.btnBg, color: t.btnColor,
            border: 'none', borderRadius: '30px', cursor: 'pointer',
        ...
        <div style={{ marginTop: '20px', fontSize: '14px', color: t.textSecond }}>
          ...
          <p style={{ marginBottom: '20px' }}>
            ...
            <span onClick={() => setLoginStep('signup')} style={{ color: t.textPrimary, fontWeight: 'bold', cursor: 'pointer' }}>Sign Up</span>
          </p>

          {/* OR LOG IN WITH icons */}
          <div style={{
            display: 'flex', justifyContent: 'center', alignItems: 'center',
            gap: '25px', marginTop: '20px', paddingTop: '20px',
            borderTop: `1px solid ${t.textSecond}33`,
          }}>
            <img src="/google-icon.png" alt="Google" onClick={() => setLoginStep('google')}
              style={{ width: '40px', height: 'auto', cursor: 'pointer', opacity: theme === 'dark' ? 0.85 : 1 }} />
            <img src="/apple-icon.png" alt="Apple" onClick={() => setLoginStep('apple')}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundColor: theme === 'dark' ? 'rgba(0,0,0,0.72)' : 'rgba(0,0,0,0.5)',
        zIndex: 1,
      }} />
      ...
      <div style={{
        ...
        backgroundColor: t.cardBg, border: t.cardBorder,
      ...
      <style>{`
        ...
        input::placeholder { color: ${t.textSecond}; }
      `}</style>
    </div>
  );
}